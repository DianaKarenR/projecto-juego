...
while (True):
   ...
   if(camino==1):
     ...
     puertav=input("a-you say hello.  b-the old lady ask you to enter and you do. c-ask who she is (please answer a, b or c)")
   ...
   if (entaraacasa=="a"):
     ...
     if (jugarunjuego==a):
       ...
       if (juegos=="1"):
         print("you have chosen the glass of ¿wine?")
           ...
           if(yon=="b"):
             ...
             if(phone=="a"):
               ...
               if (phonea=="b"):
                 ...
                 print("with no control over your movement you open a door and let the shadow ¿stab? you")
                 print("YOU DIED")
                 print("GAME OVER")
                 break
